...
const LABEL_CODEX_ITEMS = [
  ...
  { text: 'Consistency shapes the identity of GNOS.', accent: true },
    ...
    <section className={styles.page}>
      <div className={styles.container}>
          ...
          <div className={`${styles.frameContent} ${styles.frameContentBottom} ${styles.missionVisionPanel}`}>
            <div className={styles.missionVisionRow}>
              <div className={`${styles.missionCol} ${styles.diagonalMission}`}>
                <h2 className={`${styles.sideHeading} ${styles.missionVisionHeading}`}>Mission</h2>
              ...
              <div className={`${styles.visionCol} ${styles.diagonalVision}`}>
                <h2 className={`${styles.sideHeading} ${styles.missionVisionHeading}`}>Vision</h2>
                <p className={`${styles.paragraph} ${styles.missionVisionParagraph}`}>
        ...
        <div className={styles.frameWrapper}>
          ...
          <div className={`${styles.frameContent} ${styles.frameContentBottom} ${styles.codexPanel}`}>
            <h2 className={`${styles.heading} ${styles.codexHeadingMain}`}>Label Codex</h2>
